"""What the bus carries: addresses, registers, and the tables to decode them.

Every value here was read off a real unit or its panel; docs/PROTOCOL.md in
the integration repository records how each one was established.
"""

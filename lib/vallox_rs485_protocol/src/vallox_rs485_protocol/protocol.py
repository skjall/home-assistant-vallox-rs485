...
class ValloxState:
    ...
    remote_control_working: bool | None = None
    fireplace_boost_active: bool | None = None
...
def create_read_request(
    register: int, sender: int = ADDR_THIS_DEVICE
) -> ValloxTelegram:
    """Create a read request telegram.

    Per Vallox protocol: VARIABLE=0x00, DATA=<register to read>
    """
